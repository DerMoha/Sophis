...
class _HomeScreenModernState extends State<HomeScreenModern>
          ...
          builder: (context, scrollOffset, child) {
            return SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                expandedTitleScale:
                    1.0, // Prevent font scaling during transition
          ...
          sliver: SliverList(
            delegate: SliverChildListDelegate([
              ...
              FadeInSlide(
                index: 1,
                child:
                    _buildMacroRingsCard(context, l10n, theme, totals, goals),
              ),
  ...
  Widget _buildQuickActionsRow(
    ...
    if (settings.quickActionSize == QuickActionSize.large) {
      // Use grid layout for large buttons
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Padding(
          ...
          _buildQuickActionsGrid(context, l10n, theme, settings),
        ],
      );
    }
  ...
  Widget _buildQuickActionChip(
    ...
    final (icon, label, color, onTap) =
        _getQuickActionData(context, l10n, theme, id);
    ...
    switch (id) {
      case DashboardCardIds.foodDiary:
        return (
          ...
          theme.colorScheme.primary,
          () => Navigator.push(
              context, AppTheme.slideRoute(const FoodDiaryScreen())),
        );
      case DashboardCardIds.mealPlanner:
        return (
          ...
          null,
          () => Navigator.push(
              context, AppTheme.slideRoute(const MealPlannerScreen())),
        );
      case DashboardCardIds.weight:
        return (
          ...
          null,
          () => Navigator.push(
              context, AppTheme.slideRoute(const WeightTrackerScreen())),
        );
      case DashboardCardIds.recipes:
        return (
          ...
          null,
          () => Navigator.push(
              context, AppTheme.slideRoute(const RecipesScreen())),
        );
      case DashboardCardIds.activity:
        return (
          ...
          null,
          () => Navigator.push(
              context, AppTheme.slideRoute(const ActivityGraphScreen())),
        );
  ...
  Widget _buildMealSection(
    ...
    final showMacros =
        context.select<SettingsProvider, bool>((s) => s.showMealMacros);
    final theme = Theme.of(context);
        ...
        addMenu: Row(
          ...
          children: [
            ...
            PopupMenuButton<String>(
              ...
              onSelected: (value) =>
                  _handleMealAction(context, value, mealType),
              itemBuilder: (_) => [
                _buildPopupItem(
                    Icons.edit_outlined, l10n.manualEntry, 'manual'),
                _buildPopupItem(
                    Icons.search_outlined, l10n.searchFood, 'search'),
                _buildPopupItem(Icons.qr_code_scanner_outlined,
                    l10n.scanBarcode, 'barcode'),
                _buildPopupItem(
        ...
        entries: entries.isEmpty
            ...
            : entries
                .map((entry) => FoodEntryTile(
                      ...
                      fat: entry.fat,
                      onLongPress: () =>
                          _showEntryOptions(context, l10n, entry),
                    ))
                .toList(),
      ),
    );
  ...
  void _showEntryOptions(
      BuildContext context, AppLocalizations l10n, FoodEntry entry) {
    final theme = Theme.of(context);
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color:
                        AppTheme.fire.withOpacity(0.3 * _glowAnimation.value),
